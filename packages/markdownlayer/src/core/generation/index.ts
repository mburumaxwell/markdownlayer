...
import type { BaseDoc, DocumentDefinitionGitOptions, GenerationMode, TocItem } from '@/core/types';
...
function getDocumentDefinitionGitOptions(git: boolean | DocumentDefinitionGitOptions): DocumentDefinitionGitOptions {
  const { updated = true, authors = false } = git && git !== true ? git : {};
