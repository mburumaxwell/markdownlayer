...
import type { DocumentDefinition, GenerationMode, ResolvedMarkdownlayerConfig } from './types';
...
async function generateInner(config: ResolvedMarkdownlayerConfig) {
...
type GenerateDocsOptions = DocumentDefinition & { type: string; config: ResolvedMarkdownlayerConfig };
